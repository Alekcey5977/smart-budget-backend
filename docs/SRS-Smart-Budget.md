...
- Автоматическое подключение к системе "*псевдо-банк*" при вводе банковского счета.
...
1. Пользователь видит на дашборде поле - добавить счет.

2. Нажимает кнопку "*Подключить счет*".
...
### Сделать возможность добавлять несколько счетов
