...
async def register(user_data: RegisterRequest):
    ...
    - `patronymic` (необязательный, строка или null) - Отчество пользователя
    ...
    - `422 Validation Error` - Ошибки валидации входных данных (пароль < 2 символов, имя/фамилия пустые и т.д.)
...
async def update_me(
    ...
    - `patronymic` (строка, опционально) - Новое отчество пользователя (2-50 символов)
